...
table.select({
    view: "Suscripción",
    fields: ["CC#","Cédula", "Cuencos", "Last Modified","URLs","Phone","Fecha","Descuencos"],
    ...
    records.forEach(function(record) {
        ...
        let card = new Card(record.get('CC#'),record.get('Cédula'),record.get('Cuencos'),record.get('URLs'),record.get('Phone'),record.get('Fecha'),record.get('Descuencos'));
